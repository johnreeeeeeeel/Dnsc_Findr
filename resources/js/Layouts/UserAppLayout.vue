...
export default {
    ...
    methods: {
        ...
        onFileChange(e) {
            ...
            this.isUploadingImage = true;   // show loading
            ...
            reader.onload = (event) => {
                ...
                this.isUploadingImage = false; // hide loading
            };
        ...
        async createAppointment() {
            ...
            try {
                await axios.post('/api/appointments', this.apptForm);
                ...
                this.$emit('appointment-created'); // or refresh list
                bootstrap.Modal.getInstance(document.getElementById('createApptModal')).hide();

                // Optional: show success toast
                this.showSuccessToast('appointmentSuccess');
        ...
        startAppointmentPolling() {
            ...
            if (this.appointmentPolling) {
                clearInterval(this.appointmentPolling);
            }
    ...
    <div class="layout">
        ...
        <header id="header" class="header">
            ...
            <div class="header-right">
                ...
                <!-- Appointment Button in header-right -->
        ...
        <aside id="desktopSidebar" class="desktopSidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" :class="(isActive('/home') || isActive('/dashboard')) ? 'active' : ''"
                        href="/home">
                        <Icon class="icon" icon="mingcute:home-2-fill" />
                        Home
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" :class="isActive('/my-posts')" href="/my-posts">
                ...
                <li class="nav-item">
                    <a class="nav-link" :class="isActive('/give-feedback')" href="/give-feedback">
                        <Icon class="icon" icon="mingcute:star-fill" />
                        Give Feedbacks & Ratings
                    </a>
                </li>
            </ul>
            ...
            <div class="offcanvas-body">
                ...
                <div v-if="!selectedNotification">
                    ...
                    <div v-else class="notification-list">
                        <div v-for="notif in notifications" :key="notif.id" class="notification-item"
                            ...
                            <!-- Message Preview -->
                            <small class="preview" v-html="formatMessage(notif.message)"></small>
                ...
                <div v-else class="expanded-view">
                    ...
                    <div class="content">
                        ...
                        <div class="mb-3" v-html="formatMessage(selectedNotification.message)"></div>
        ...
        <div class="offcanvas offcanvas-end" id="appointments" tabindex="-1">
            ...
            <div class="offcanvas-body">
                ...
                <div class="schedule-appt-btn">
                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#createApptModal">
        ...
        <div class="modal fade primary-modal" id="createApptModal" tabindex="-1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <Icon icon="mingcute:calendar-add-line" class="icon" />
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="createAppointment">
                            ...
                            <div class="mt-3">
                                ...
                                <input type="date" v-model="apptForm.schedule_date" class="form-control" :min="today" />
                                <p v-if="inputErrors.schedule_date" class="error-text mt-1">
                                    {{ inputErrors.schedule_date[0] }}
                                </p>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <input type="time" v-model="apptForm.schedule_time" class="form-control" />
                                <p v-if="inputErrors.schedule_time" class="error-text mt-1">
                                    {{ inputErrors.schedule_time[0] }}
                                </p>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="dropdown w-100">
                                    <button class="btn dropdown-toggle" :class="{ 'is-invalid': inputErrors.purpose }"
                                        type="button" data-bs-toggle="dropdown">
                                        {{ apptForm.purpose || 'Select Purpose' }}
                                    </button>

                                    <ul class="dropdown-menu w-100">
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                @click.prevent="apptForm.purpose = 'Report Item'">
                                                Report Item
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                @click.prevent="apptForm.purpose = 'Claim Item'">
                                                Claim Item
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <!-- Error for Purpose -->
                                <p v-if="inputErrors.purpose" class="error-text mt-1">
                                    {{ inputErrors.purpose[0] }}
                                </p>
                            </div>
                            ...
                            <div class="action-buttons mt-4">
                                <button type="submit"
                                    ...
                                    <span v-if="apptSubmitting" class="spinner-border spinner-border-sm" role="status"
                                        aria-hidden="true"></span>

                                    <span v-if="apptSubmitting">
                                        Submitting...
                                    </span>
                                    <span v-else>
                                        Submit Appointment
        ...
        <div class="success-toast">
            <div id="appointmentSuccess" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                        ...
                        <form @submit.prevent="submitPost">
                            ...
                            <div class="mt-3">
                                <label class="form-label">
                                    ...
                                    <span v-if="inputErrors.item_name" class="input-error">{{ inputErrors.item_name[0]
                                        }}</span>
                                </label>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu w-100">
                                        <li><a class="dropdown-item" href="#"
                                                @click.prevent="form.item_category = 'ID / Student Card'">ID / Student
                                                Card</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                @click.prevent="form.item_category = 'Electronics'">Electronics</a></li>
                                        <li><a class="dropdown-item" href="#"
                                                @click.prevent="form.item_category = 'Documents'">Documents</a></li>
                                        <li><a class="dropdown-item" href="#"
                                                @click.prevent="form.item_category = 'Accessories'">Accessories</a></li>
                                        <li><a class="dropdown-item" href="#"
                            ...
                            <div class="mt-3">
                                <label class="form-label">
                                    ...
                                    <span v-if="inputErrors.date_found" class="input-error">{{ inputErrors.date_found[0]
                                        }}</span>
                                </label>
                            ...
                            <div class="mt-3">
                                <label class="form-label">
                                    ...
                                    <span v-if="inputErrors.time_found" class="input-error">{{ inputErrors.time_found[0]
                                        }}</span>
                                </label>
